...
def app():
    ...
    if st.button("Generate Syllabus"):
        if question:
            ...
            prompt = f"""
                Create a course syllabus for the requested topic. Please provide the required version from these three versions: Beginner, Intermediate, and Advanced.if version is not specified then provide beginner version. Each version should have the following components:

                - Course Title and Level: {question} 
                - Course Description: A brief overview of what the course covers.
                - Course Outline: Provide a detailed weekly breakdown based on the(or module structure) with key topics covered per week/module and with their multiple lessons.
                - Course time commitment: Indicate the estimated time commitment required per week.
                ...
                **Advanced**: Cover complex topics, real-world applications, and advanced projects or case studies.
                ...
                ### IF LEVEL IS NOT SPECIFIED BY THE USER THEN GIVE THE BEGINNER LEVEL OF SYLLABUS ###
